...
public class Semestre7 extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position == 0) {
					Intent intent = new Intent(Semestre7.this,GenericView.class);
	...
	static final String disciplinas[] = new String[] { "Teoria da Computação",
			"Construção de Compiladores", "Informática e Sociedade"};
