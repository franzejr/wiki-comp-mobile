...
public class Semestre2 extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position == 0) {
					Intent intent = new Intent(Semestre2.this,GenericView.class);
	...
	static final String disciplinas[] = new String[] { "Programação",
			"Estrutura de Dados", "Cálculo II", "Transmissão de Dados",
			"Física I" };
