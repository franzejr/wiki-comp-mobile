...
public class Semestre3 extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position == 0) {
					Intent intent = new Intent(Semestre3.this,GenericView.class);
	...
	static final String disciplinas[] = new String[] { "Introdução à Lógica Matemática",
			"Introdução à Probabilidade e Estatística", "Algoritmos em Grafos", "Técnicas de Programação I",
